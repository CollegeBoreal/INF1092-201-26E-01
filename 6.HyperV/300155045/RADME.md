...
| --------------------------- | ------------- |
| Nom de la machine virtuelle | VM300155045   |
...
* le nom de la VM est `VM300155045`;
...
La machine virtuelle `VM300155045` a été créée avec les paramètres demandés et Windows Server 2022 a été installé avec succès.
...
8. la machine virtuelle `VM300155045` en fonctionnement.
